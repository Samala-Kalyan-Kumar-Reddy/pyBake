...
class ProductReport():
    def __init__(self,root,user):
        self.root =root
        self.user = user
        self.root.title("Product Report")
        ...
        self.report_label = tk.Label(self.product_info_frame, text="All Products Report", font='Poppins, 15', anchor="c",bg = "#EEEEEE")
        ...
        self.tree = ttk.Treeview(self.report_body_frame,column=("1", "2", "3", "4"), show='headings')
        ...
        self.tree.heading("#1", text="Product Code")
        ...
        self.tree.column("#4", anchor=tk.CENTER,width=500)
        self.tree.heading("#4", text="Product Description")
    ...
    def display(self):
        products_info = self.product.get_products()
