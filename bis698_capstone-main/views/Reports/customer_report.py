...
class CustomerReport():
    def __init__(self,root,user):
        self.root =root
        self.user = user
        self.root.title("Customer Report")
        ...
        self.report_label = tk.Label(self.customer_info_frame, text="Report on all Customers", font='Poppins, 15', anchor="c")
    ...
    def display(self):
        print(self.customer)
        data = self.customer.get_customers()
